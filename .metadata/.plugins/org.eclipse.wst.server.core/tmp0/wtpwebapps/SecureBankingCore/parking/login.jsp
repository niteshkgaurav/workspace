...
<body>
	...
	<form:form id="adminForm" method="post" modelAttribute="loginData"
		action="/Transits/login/validateAccount.html">
		<div id="wrapper">
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
									<c:if test="${statusMessage!=''}">
										<div   class=" col-xs-12 col-sm-12 col-md-12 col-lg-12  text-center" >
	                                            <p id="statusmsgId"><font color="red">${statusMessage}</font></p>
	                                           
										</div> 
									</c:if>	
									<c:if test="${successsMessage!=''}">
										<div   class=" col-xs-12 col-sm-12 col-md-12 col-lg-12  text-center" >
	                                            <p id="successMessageID"><b><font color="green">${successsMessage}</font></b></p>
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											...
											<div id="div_username" class="styled-input">
												<form:input type="text" class="selecttag" id="username" path="username"
													name="username" onchange="selecttag('username1','username');" onfocus="removeHasError('div_username')"
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div id="div_password" class="styled-input">
												<form:input type="password" id="password" class="selecttag" path="password" name="password"
													onchange="selecttag('password1','password')" onclick="usererrormessage(event); removeMessage();" 
													autocomplete="off" onfocus="removeHasError('div_password')"/>
												<label id="password1">Password</label> <span></span>
											</div>
										</div>
										<div
