...
<form:form method="post"	modelAttribute="data"
		action="${pageContext.request.contextPath}/AdminUI/commission/getAgentApiMapping">
					...
					<th>Agent Company</th>
					 ...
					 <c:forEach items="${data.dataAll}" var="accountinfo" varStatus="status" >
										<tr>
											...
											<td width="10%"> <form:checkbox class="agentCheck"
					...
					<th>Host=>Distributor=>Sub-Distributor Hierarchy</th>
					 ...
					 <c:forEach items="${data.companyList}" var="accountinfo" varStatus="status">
										<tr>
											...
											<td width="10%"> <form:checkbox class="companyCheck" name="companyCheck"
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb" id="apiSerevices">
			...
			<input type="submit" class="btn btn-warning" value="Submit" onclick="return validateApiform()" />
