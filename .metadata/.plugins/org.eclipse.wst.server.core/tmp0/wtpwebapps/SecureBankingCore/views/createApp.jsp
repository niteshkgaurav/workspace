...
<body >
	<form:form  modelAttribute="cardApps" method="post" action="${pageContext.request.contextPath}/AdminUI/appManagement/appDataSubmit" enctype="multipart/form-data">
		 <div class="heading-inner  ">
	     <!-- ****************************************** Form Heading  ******************************* -->
	            <h1 class="pull-left"><spring:message code="LABEL_APP_CREATION"/></h1>
		...
		<div class="row" id="account">
				...
				<div class="styled-input" id="appNamestyled-input">
					...
					<form:input type="text" minlength="5" maxlength="50" class="selecttag" path="apName" id="apName"
						onclick="emptyerror(event,'appNameErrorId');refresh('successMessageId');" 
						onfocus="removeHasError('appNamestyled-input');showlabel('appNameId','appNameErrorId');emptyerror(event,'appNameErrorId')"
					  	onChange="checkField('apName','PayCardApps','payCardAppName','appNameErrorId','appNameId'); removeClass('appNameId','apName');selecttag('appNameId','apName');"
					  	onkeypress="onlyAlphabetlatest(event,'appNameErrorId','appNameId');emptyerror(event,'appNameErrorId');"/>	
					<label id="appNameId"><spring:message code="label_payCardApp" /></label>  
				...
				<div class="styled-input" id="appDescstyled-input">
					...
					<label id="appDescId"><spring:message code="lab_Description" /></label>  
          		 ...
          		 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	                        <div class="styled-input" id="productDiv">
			                          <form:select class="selecttag" path="product" id="productId" onclick="emptyerror(event,'productError');refresh('successMessageId');this.setAttribute('value', this.value);" value="" 
			                          onchange="selecttag('prodId','productId');showHideFunction();" 
			                          ...
			                          <form:option value="" label=" " />
			                           ...
			                           <label id="prodId"><spring:message code="lab_products" /></label>
	                       ...
	                       <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	                        <div class="styled-input" id="statusDiv">
			                          <form:select class="selecttag" path="statusValue" id="statusId" onclick="emptyerror(event,'statusError');refresh('successMessageId');this.setAttribute('value', this.value);" value=""  
			                          onchange="selecttag('statId','statusId');showHideFunction();" 
