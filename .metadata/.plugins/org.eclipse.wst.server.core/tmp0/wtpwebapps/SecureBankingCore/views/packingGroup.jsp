...
<body>
<!-- <div> -->
<form:form id="packagingGroupCreation" method="post"  modelAttribute="packingGroupData" action="${pageContext.request.contextPath}/AdminUI/inventoryMgmtController/groupCreationSubmit">
	          <div class="row">
...
%>
	     ...
	     <!-- ****************************************** Form Heading  ******************************* -->
                ...
                <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center">
          			<div class="styled-input productDiv">
					    ...
					    onChange="selecttag('productTypeId','productType');changeLevel();"> 
					    	<form:option value="0" label=""  />
                            	<%-- <form:option value="READER" label="READER"/>
	  							...
	  							<form:option value="${product.type}" label="${product.productName}"/>
	  							</c:forEach>
	  					</form:select>
	                     <label id="productTypeId"class="valid">${lab_productGroup}</label>
	             ...
	             <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					...
					<form:select id ="levelNumber" type="text" class="levelNumber" path="levelNumber" 
							onchange="getGroupsForSelectedProduct();"	 >
							 </form:select>
							<label id="groupNameId" class="valid">Level</label>  
							<label id="levelErrorId" class="collapse"></label>
						</div>
					</div>
	             ...
	             <!--  Lavel ended -->
			        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="styled-input">
							...
							<label id="groupNameId" class="valid">${lab_GroupName}</label>  
							<label id="groupNameErrorId" class="collapse"></label>
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center">
          			<div class="styled-input consistsOfGroup">
					    ...
					    onChange="selecttag('parentTypeId','parentType');removequantity();"> 
                            	<form:option value="" label=" "/>
	  							<%-- <form:options items="${parentDataList}"/> --%>
	  					</form:select>
	                     <label id="parentTypeId"class="valid">${lab_parentGroup}</label>
	             ...
	             <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="styled-input">
							...
							<label id="quantityId" class="valid">${lab_quantity}</label>  
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="styled-input">
							...
							<label id="quantityId"class="valid" >${lab_noOfBoxes}</label>  
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt text-center">
	  					<input type="submit" class="btn btn-warning"  value="Submit" onclick="return validatePackingGroup();"/>
					</div>
					
				</div>
					<!-- <input type="hidden" id="levelNumber" name="levelNumber" value='0'/> -->
