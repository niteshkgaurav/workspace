...
<body class="PageType">
	...
	<div class="heading-inner  ">
		<!-- ****************************************** Form Heading  ******************************* -->
		<h1 class="pull-left">Merchant Transactions Detail Report</h1>
	...
	<div class="row">
	<form method="post" action="manage-merchant-transaction" >
			...
			<div class="transaction-table">
				<div class="table-responsive">
					<table class="table table-bordered table-striped" id="table_id3">
						...
						<c:forEach items="${merchantTransactions}" var="transaction">
									<tr>
									...
									<td align="center">${transaction.deviceId}</td>
