...
<body class="PageType">
	...
	<div class="heading-inner  ">
		<!-- ****************************************** Form Heading  ******************************* -->
		<h1 class="pull-left">Card Subscription Report</h1>
	...
	<div class="row">
	<form method="post" action="manage-card-subscriptions-transaction" >
			...
			<div class="transaction-table">
				<div class="table-responsive">
					<table class="table table-bordered table-striped" id="table_id3">
						...
						<tbody>
						<c:forEach items="${cardSubs}" var="transaction">
									<tr>
									
									<td align="center">${transaction.agentName}</td>
									<td align="center">${transaction.msisdn}</td>
									<td align="center">${transaction.toltalPayAmount}</td>
									<td align="center">${transaction.transactionAmount}</td>
									<td align="center">${transaction.noOfTransactions}</td>
									<td align="center">${transaction.serviceCharge}</td>
									<%-- <td align="center">${transaction.agentCity}</td> --%>
									<td align="center">${transaction.productStatus}</td>
