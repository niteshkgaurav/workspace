...
<title>Portal Commission Template Edit</title>
</head>
<body>
	<form:form id="CommissionTemplateCreationForm"
		...
		action="${pageContext.request.contextPath}/AdminUI/portalCreation/updatePortalCommTempEdit">
		<table width='70%' border='0' align='center' class='tableMain'
					...
					<table>
						...
						<tr>
							...
							<td><form:input id="tempName" path="name" name="tempName"
									style="width:180px;" type="text" placeholder="Template Name"
									maxlength='50'
									onchange="checkDuplicate();emptyerror(event,'errmsgTempName')" />
						</tr>
						<tr>
							<td width="25%"></td>
						...
						<tr>
							...
							<td><form:select style="width:180px;" id="templateCommType"
									name="templateCommType" path="templateCommType">
						...
						<tr>
							...
							<td><form:input id="inputTax" path="tax" name="inputTax"
									style="width:80px;" type="text" placeholder="Tax" maxlength='6' /></td>
						</tr>
						<tr>
									...
									<tr>
										<td align='center'>
											<table width='85%' align='center' class='tableMain'
												...
												<tr>
													<td><font color="red">*&nbsp;</font> <spring:message
															code="LABEL_VALUE" />&nbsp;:&nbsp; <form:input
															id="custCommFixedValue" path="senderCommFixedValue"
															name="custCommFixedValue" style="width:98px;" type="text"
															placeholder="Value" maxlength='7' /> </br> <span
														id="errmsgCustomerCommissionFixedValue" style="color: red"></span></td>
												</tr>
												<%-- <tr>
													<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message
															code="LABEL_MIN" /> : <form:input id="custCommFixedMin"
												...
												<tr>
													<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message
															code="LABEL_MAX" /> : <form:input id="custCommFixedMax"
											...
											<table width='80%' id="customerRangeMainTable"
												...
												<tr id="customerRangeTableId">
													<td align="center">
														<table id="customerRangeTable" name="customerRangeTable"
															width='85%' border='0' align='left' class='tableMain'
															...
															<c:forEach var="listVar"
																items="${sysCommissionConfigurationData.sysConfigRangeCustomer}"
																varStatus="loop">
																<tr>
																	<td><input type="text"
																		name="sysConfigRangeCustomer[${loop.index+1}].min"
																		value="${listVar.min }" /></td>
																	<td><input type="text"
																		name="sysConfigRangeCustomer[${loop.index+1}].max"
																		value="${listVar.max }" /></td>
																	<td><input type="text"
																		name="sysConfigRangeCustomer[${loop.index+1}].value"
																		value="${listVar.value }" /></td>
																	<td style="visibility: hidden;"><input type="text"
																		name="sysConfigRangeCustomer[${loop.index+1}].type"
																		value="PORTAL" /></td>
																</tr>
												...
												<tr id="addButtonId">
													<td><INPUT type="button" value="Add Row"
														onclick="addRow('customerRangeTable','PORTAL')" /> <INPUT
			...
			<tr align="center">
				...
				<td align="left"><form:select id="accountStatus" path="status"
						name="portalStatus" onchange="checkActiveCommission()">
						<form:option value="0" label="Active" />
						<form:option value="1" label="Inactive" />
					</form:select></td>
			</tr>
			<tr>
				<!-- <td width="25%"></td> -->
				<td align="center" colspan="2"><div id="errmsgActiveType" ></div></td>
			</tr>
			<c:choose>
				<c:when test="${empty sysCommissionConfigurationData.showBack}">
					<tr height='15'>
				...
				<c:otherwise>
					<tr height='15'>
						<td colspan='2' align='center'><input type='button'
							value="back " onClick="getBack()"></td>
					</tr>
				</c:otherwise>
			</c:choose>

			<tr>
				<td><input type="hidden" id="sysCommConfigId"
					name="sysCommConfigId" value="${sysCommConfigId}"></td>
			</tr>
		</table>
	</form:form>
</body>
