...
<form:form id="" method="post"
		modelAttribute="accountTypeData" action="${pageContext.request.contextPath}/AdminUI/roleController/roleEdit">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="vendor">
			<div id="divID_menu" class="styled-input">
				<form:select name="menuId" path="menucheckBox" class="selecttag" id="menuId" 
					onfocus="removeHasError('divID_menu')"
					onclick="this.setAttribute('value', this.value);"
					value="" onchange="selecttag('label_menuId','menuId');">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb">
					...
					<div class="table-responsive">
						<div id="menuTableId" style="height: 300px;overflow: auto;">
								...
								<tr class="tableLabel">
								<td><form:checkbox	path="sysAccountGroupArray"  class="accountcheckBox" name="accountcheckBox" id="accountcheckBox${sysAccountLst.id}" value="${sysAccountLst.id}" /></td><td>${sysAccountLst.accountType}</td>
