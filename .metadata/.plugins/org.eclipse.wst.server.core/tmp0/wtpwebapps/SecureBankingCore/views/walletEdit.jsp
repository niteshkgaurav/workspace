...
<body >
	<form:form  modelAttribute="walletData" method="post" action="${pageContext.request.contextPath}/AdminUI/walletManagement/updateWallet" enctype="multipart/form-data">
		 <div class="heading-inner  ">
	     <!-- ****************************************** Form Heading  ******************************* -->
	            <h1 class="pull-left"><spring:message code="lab_walletEdit"/></h1>
		...
		<div class="row" id="account">
			...
			<div class="styled-input" id="walletNamestyled-input">
					...
					<form:input type="text" class="selecttag" path="walletTypeName" id="walletTypeName"  readonly="true"
						onclick="emptyerror(event,'walletNameErrorId');" onfocus="removeHasError('walletNamestyled-input');"
					  onChange="selecttag('walletNameId','walletName');"/>
				...
				<div class="styled-input" id="walletDescstyled-input">
					...
					<form:input type="text"  maxlength="200" class="selecttag" path="walletTypeDesc" id="walletTypeDesc" readonly="true"
						onclick="emptyerror(event,'walletDescErrorId');" onfocus="removeHasError('walletDescstyled-input');"
					  	onChange="selecttag('walletNameId','walletName');"/>
					...
					<label id="walletDescErrorId" class="collapse"></label>
	                      ...
	                      <div class="styled-input" id="statusDiv">
			                          <form:select class="selecttag" path="status" id="statusId" onclick="emptyerror(event,'statusError');this.setAttribute('value', this.value);" value=""  
       ...
       <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
				...
				<div class="styled-input" id="walletAmountstyled-input">
					...
					<form:input type="number"  min="1" max="100000" class="selecttag" path="amount" id="walletTypeAmount" 
						onclick="emptyerror(event,'walletAmountErrorId');" onfocus="removeHasError('walletAmountstyled-input');"
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt text-center" id="submit">
					<input type='submit' class="btn btn-warning"  value="Update" onclick="return validateCreateWallet(event);">
					</div>
		</div>	
