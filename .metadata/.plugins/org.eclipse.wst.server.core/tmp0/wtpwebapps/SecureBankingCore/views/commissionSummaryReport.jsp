...
<form:form id="formDown" method="post"
		...
		modelAttribute="misReportData"  action="${pageContext.request.contextPath}/AdminUI/miscontroller/commissionSummaryReport">
		<input type="hidden" id="action" name="action"/>
		
		<div class="heading-inner">
	     <!-- ****************************************** Form Heading  ******************************* -->
	     <h1 class="pull-left">Commission Summary Report</h1>
			...
			<br>
			 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
				...
				<div class="input-group date datetimepicker1" >
					...
					<form:input type="text" id="startDate" path="startDate" onclick="removeError();selct('startDateId');selecttag('startDateId','startDate');emptyerror(event,'startDateErrorId');" class="selecttag"
			...
			<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
				...
				<div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
	                        <div class="styled-input" id="hostDiv">
			                          ...
			                          <form:select class="selecttag" path="distributorId" id="host" onclick="emptyerror(event,'productError');this.setAttribute('value', this.value);" value="" 
			                          ...
			                          <form:option value="" label=" " />
			                           ...
			                           <label id="hostId" class="valid">Distributer </label>
			 ...
			 <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
	                        <div class="styled-input" id="hostDiv">
			                          ...
			                          <form:option value="" label=" " />
			                           ...
			                           <label id="hostId" class="valid">Agent </label>
			                          <label id="hostError" class="collapse"></label>
	                          </div>
	                      </div>
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb" >
                 <div class="transaction-table" >
                    <div class="table-responsive" >
                     <table class="table table-bordered table-striped" id="table_id3" width="100%">
	  						<thead class="default">
		  						<tr >
	  						...
	  						<c:forEach items="${reportData}" var="trxnCommissionlistData">
								<tr>
									...
									<td align="left">${trxnCommissionlistData.txnAmount}</td>
								</tr>
							</c:forEach>
	  						</tbody>
	  					</table>
