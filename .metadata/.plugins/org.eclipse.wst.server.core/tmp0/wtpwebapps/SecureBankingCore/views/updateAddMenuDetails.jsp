...
<form:form id="" method="post"
		modelAttribute="addMenuData" action="${pageContext.request.contextPath}/AdminUI/roleController/saveEditMenu">
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									...
									<form:hidden path="accountTypeId"  name="accountTypeId" id="accountTypeId" value='${accountTypeId}' onclick="remove_error();"/>
									...
									<input type="submit" class="btn btn-warning" value="Update" onclick="return validateEditMenu(event)" />
								</div>
