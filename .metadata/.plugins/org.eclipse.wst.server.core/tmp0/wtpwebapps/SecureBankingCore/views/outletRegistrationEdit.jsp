  ...
  <div class="modal-content">
   <span class="close" >X</span>
		...
		<form:form 	id="appList" method="post" modelAttribute="merchantData"
			action="${pageContext.request.contextPath}/AdminUI/merchantMgmnt/outletRegistrationEdit"
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<c:otherwise>
				...
				<div id="ifscCodeSelectDivId" class="styled-input">
					...
					<input type='submit'class="btn btn-warning"  value="Submit" onclick="return validateOutlet(event,'${deployedFor}','${merchantData.id}');">
					</div>
	            <form:input type="hidden" id="merchantId" path="id" value="${merchantData.id}" />   
	            <input type="hidden" id="pinaddressId" name="pinaddressId" value="${merchantData.pinaddressId}" />           	  
