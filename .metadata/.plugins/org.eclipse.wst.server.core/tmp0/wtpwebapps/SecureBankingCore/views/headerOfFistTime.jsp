        ...
        <header>
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="login-details">
              <ul>
                <li class="hidden-xs hidden-sm"><img src="/securebanking/images/user.png" alt=""><a href="#"></a></li>
                <li><a href="${pageContext.request.contextPath}/AdminUI/login/getLoginPage"><b>Login</b></a></li>
              </ul>
            </div>
          </div>
          ...
          <nav class="navbar navbar-default">
            <div class="container-fluid"> 
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="/securebanking/images/logo.gif" alt="" width="90"></a> </div>
