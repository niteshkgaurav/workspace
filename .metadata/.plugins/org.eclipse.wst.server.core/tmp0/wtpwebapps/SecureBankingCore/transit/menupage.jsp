...
<body>
                  ...
                  <section class="white pad-null">
                    ...
                    <li class='has-sub'><a href="${pageContext.request.contextPath}/AdminUI/login/layoutUser?menuId=${catLevel1.getId()}&menuname=${catLevel1.getMenuName()}">${catLevel1.getMenuName()}</a>
