...
function getInventoryDetails(event){
	...
	function getBoxDetails1(){
		...
		ajax:'ajax/getBoxDetailAjax?fromDate='+fromDate+'&endDate='+endDate+'&status='+status+'&orderTypeVl='+orderTypeVl,
		...
		columns: [
		            ...
		            { "data": "status" },
		            {
                        "data": function (data, type, row, meta) {
                                          return '<a href="ajax/getInventorydetailofremap?fromDate='+fromDate+'&endDate='+endDate+'&status='+status+'&tagName='+tagName+'">' + data.noOfProducts + '</a>';
                                  }
                       },
		            //{ "data": "noOfProducts"}
		...
		if(undefined!=table){
			...
			table =  $('#template_details1').DataTable( {
				    ...
				    paging: true,	
		ajax:'ajax/getBoxDetailOnBehalfAjax?fromDate='+fromDate+'&endDate='+endDate+'&status='+status+'&tagName='+tagName,
		...
		columns: [
		            ...
		            {
                        "data": function (data, type, row, meta) {
                                          return '<a href="ajax/getInventorydetail?fromDate='+fromDate+'&endDate='+endDate+'&status='+status+'&tagName='+tagName+'">' + data.noOfProducts + '</a>';
                                  }
                       },
		            //{ "data": "noOfProducts"}
	...
	function productTypeCheck() {
	 ...
	 //location.reload(false);
		var orderTypeVl=$("#InventoryFor").val();
		var groupCode= $("#onbehalf_Account").val();
